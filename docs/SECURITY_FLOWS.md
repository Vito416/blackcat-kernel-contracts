...
sequenceDiagram
  ...
  Root->>IC: setAttestation(sha256("blackcat.runtime_config.canonical_sha256.v1"), configHash)
  Root->>IC: lockAttestationKey(sha256("blackcat.runtime_config.canonical_sha256.v1"))

  Runtime->>FS: Read runtime config bytes
  Runtime->>Runtime: Compute configHash (same canonicalization)
  Runtime->>IC: eth_call attestations[sha256("blackcat.runtime_config.canonical_sha256.v1")]
